...
export default function Session() {
  ...
  useEffect(() => {
    ...
    setUserName(uniqueNamesGenerator(nameGenConfig));
  ...
  return (
    <div>
      ...
      <main className="h-screen flex flex-col items-center justify-center gap-16">
        ...
        <ul className="fixed bottom-4 flex justify-center items-center gap-4 bg-base-300 border border-primary py-4 px-8 rounded-xl z-20 shadow-lg">
